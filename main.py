    ...
    while True:
        ...
        while True:
            ...
            if service == 0:  # Exit
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[?] Enter your new ID.'))
                ...
                if len(new_id) >= 0 and len(new_id) <=  and (' ' in new_id) == False:
                    if cpm.set_player_localid(new_id.upper()):
                        ...
                        answ = Prompt.ask("[?] ﺝﻭﺮﺨﻟﺍ ﺪﻳﺮﺗ ﻞﻫ ?", choices=["y", "n"], default="n")
                    ...
                    print(Colorate.Horizontal(Colors.blue_to_red, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.blue_to_red, 'Please use valid ID.'))
                    sleep(2)
                    continue
